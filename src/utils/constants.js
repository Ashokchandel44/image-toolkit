...
export const TOOL_CARDS = [
  { title: 'Compress Image', path: '/compress-image', description: 'Reduce image file size in the browser with quality controls and download-ready output.' },
  { title: 'Resize Image', path: '/resize-image', description: 'Resize by custom dimensions or handy presets while keeping aspect ratio when needed.' },
  { title: 'Crop Image', path: '/crop-image', description: 'Select and export a precise crop using an interactive crop area selector.' },
